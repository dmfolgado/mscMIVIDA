...
```
git clone --recursive ssh://git@git.fraunhofer.pt/mscMIVIDA/mscmivida.git
cd mscmivida
```
...
If you publish work that uses mscMIVIDA, please cite mscMIVIDA as follows:

```bibtex
@misc{mscMIVIDA mscmivida,
  author = {Fraunhofer AICOS},
  title = {Supporting code for the mscMIVIDA project.},
  year = {2025},
}
```
